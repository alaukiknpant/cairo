...
// TODO(yg): remove or try using this (if needed, add more info) FunctionWithBodyId::Trait instead
...
define_language_element_id_as_enum! {
    ...
    pub enum FunctionWithBodyId {
        ...
        // TODO(yg): Try to store here a type with nonoptional body... can we use here some inner type? What is needed here?
